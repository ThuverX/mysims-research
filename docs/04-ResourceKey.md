...
1. The instance
    ...
    - This is like the file name, as its just that, an [FNV64](FNV) hashed version of its original file name.
2. The type
    - A 32bit unsigned integer, it's the file type, for a list of knows types check [here](index.md#formats).
    - In most cases again a [FNV32](FNV) version of the original file type.
3. The group
