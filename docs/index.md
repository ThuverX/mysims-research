...
Interested in making mods? Check out the modding section [here](Modding/).
...
> Any time a "hash" or "id" is mentioned we are talking about an [FNV](./FNV) hash.
...
|---------------------------------------------------------|---------------------------------------------------------|--------------|------------------------------------------------------|
| [DBPF](Files/DBPF)                                      | MySims/Kingdom                                          |              | EA's DataBase Packed File, found as `.package` files |
| [Win32Model](Files/Win32Model)                          | MySims/Kingdom                                          | `0xB359C791` | Only used on all windows versions                    |
| [Material](Files/Material/MySims)                       | MySims/Kingdom                                          | `0x01D0E75D` | Material information                                 |
| [Clip](Files/Clip)                                      | MySims/Kingdom                                          | `0x6B20C4F3` | Granny3D animation                                   |
| Rig                                                     | MySims/Kingdom                                          | `0x8eaf13de` | Granny3D Model rig                                   |
| [Str](Files/Str)                                        | MySims/Kingdom                                          |              | String file                                          |
| [Save](Files/Save)                                      | MySims/Kingdom                                          |              | Savedata file                                        |
| Xml                                                     | MySims/Kingdom                                          | `0xDC37E964` | Generic Xml                                          |
| Physics                                                 | MySims/Kingdom                                          | `0xD5988020` | Havok baked physics                                  |
| [Big](Files/Apt/Big)                                    | MySims/Kingdom                                          | `0x5BCA8C06` | EA's big file format                                 |
| [Bnk](Files/Bnk)                                        | MySims/Kingdom                                          | `0xB6B5C271` | Audio bank                                           |
| Lua                                                     | [MySims](Files/Lua/MySims)/[Kingdom](Files/Lua/Kingdom) | `0x474999B4` | Scripts                                              |
...
| [Xmb](Files/Xmb)                                        | MySims[^3]                                              | `0x1E1E6516` | Binary Xml                                           |
...
| [Level XML](Files/Level/LevelXml)                       | MySims                                                  | `0x585EE310` | Level definition                                     |
| World XML                                               | MySims                                                  |              | World definition                                     |
| Slot Binary                                             | Kingdom                                                 | `0x487bf9e4` | Object slot information                              |
| Snap Binary                                             | Kingdom                                                 | `0xb70f1cea` |                                                      |
| [Level Binary](Files/Level/LevelBin)                    | Kingdom                                                 | `0x58969018` | Level definition                                     |
